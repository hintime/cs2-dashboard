...
def generate_ai_recommendations():
    ...
    try:
        ...
        prompt = (
            ...
            f'【推荐候选 Top20】\n{candidates_text}\n\n'
            f'请用以下格式输出（严格JSON）：\n'
            f'{{"picks":[{{"rank":1,"name":"饰品名","reason":"","risk":""}},...],"strategy":"","summary":""}}\n'
            f'理由要求（50-80字）：1)先说出具体评分和排名 2)指出哪个平台溢价最高、溢价多少% 3)说明ECO和BUFF/悠悠的在售量 4)最后给结论\n'
            f'风险要求（30-40字）：说具体风险，比如\"悠悠在售仅N件，出货慢\"或\"ECO价比BUFF高，已经买贵了\"，必须引用数据\n'
            f'禁用语：\"价格波动风险\" \"关注市场动态\" \"科隆赛事利好\" \"多平台热度\" \"溢价合理\" \"稀缺求购\"\n'
